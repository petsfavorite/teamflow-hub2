...
export default function Layout({ children }) {
    ...
    return (
        <div className="min-h-screen bg-stone-50 flex flex-col md:flex-row" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
            ...
            {/* Main Content */}
            <div className={`flex-1 transition-all duration-300 ${sidebarOpen ? 'sm:ml-64 md:ml-64' : 'sm:ml-20 md:ml-20'} ${!isFloofPage ? 'p-4 md:p-6' : ''} pt-16 sm:pt-0 pb-32 sm:pb-8 ${isFloofPage ? 'overflow-y-auto' : ''}`} style={isFloofPage ? { height: '100vh' } : {}}>
                {children}
            </div>
