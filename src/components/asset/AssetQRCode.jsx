      ...
      <html>
        <head>
          ...
          <style>
            ...
            .location { font-size: 12px; color: #94a3b8; margin: 4px 0 0; }
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="max-w-sm">
        <DialogHeader>
          <DialogTitle>QR Code — {asset.name}</DialogTitle>
        </DialogHeader>
        <div className="flex flex-col items-center gap-4 py-4">
          <div ref={printRef} className="p-4 bg-white border border-slate-200 rounded-xl">
            <QRCodeSVG value={assetUrl} size={200} level="H" includeMargin />
          </div>
          <p className="text-xs text-slate-500 text-center">Scan to go directly to this asset.<br />Print and attach to the equipment.</p>
